...
export default function NotFound() {
    return (
        <div
            className="h-screen w-full flex items-center justify-end bg-gradient-to-b from-background-end via-background-mid to-background px-6 text-foreground-invert"
        >
