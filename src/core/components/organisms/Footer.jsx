            ...
            <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-col justify-between">
                <ScrollReveal className="grid gap-12 border-b border-border/40 pb-12 md:grid-cols-[1fr,1.8fr]" preset="fadeUp" fromY={28}>
                    <div className="space-y-4">
                        ...
                        <h2 className="text-xl font-bold leading-tight text-foreground-invert sm:text-2xl md:text-3xl">
                            Rodá seguro, <br />
                            proyectá tu futuro.
                        </h2>
                        <p className="max-w-xs text-xs leading-relaxed text-foreground-invert/60 sm:text-sm">
                ...
                <ScrollReveal
                    className="mt-8 flex flex-col gap-4 text-[11px] font-medium uppercase tracking-wider text-foreground-invert/40 md:flex-row md:items-center md:justify-between"
                    preset="fadeDown"
                    delay={0.22}
                >
